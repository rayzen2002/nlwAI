    ...
    <main className="flex-1 p-6 flex gap-6">
      <div className="flex flex-col flex-1 gap-4">
        <div className="grid grid-rows-2 gap-4 flex-1">
          <Textarea placeholder="Inclua o prompt para a IA..." className="resize-none p-5 leading-relaxed"></Textarea>
          <Textarea placeholder="Resultado gerado pela IA..." readOnly className="resize-none p-5 leading-relaxed"></Textarea>
        </div>
        <p className="text-sm text-muted-foreground">
          Lembre-se: voce pode utilizar a variavel <code className="text-violet-400">{`{transcription}`} </code> no seu prompt para adicionar o 
          conteudo da transcricao do video selecionado
        </p>
      </div>
